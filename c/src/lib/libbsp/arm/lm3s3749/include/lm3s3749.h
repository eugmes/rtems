...
#define SCRCC_PWMDIV_DIV2_VAL 0
#define SCRCC_PWMDIV_DIV4_VAL 1
#define SCRCC_PWMDIV_DIV8_VAL 2
#define SCRCC_PWMDIV_DIV16_VAL 3
#define SCRCC_PWMDIV_DIV32_VAL 4
#define SCRCC_PWMDIV_DIV64_VAL 5
