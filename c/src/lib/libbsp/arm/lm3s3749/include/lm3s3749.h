...
#define LM3S3749_SYSCON_BASE 0x400fe000
...
#define LM3S3749_SYSCON ((volatile lm3s3749_syscon *)LM3S3749_SYSCON_BASE)
...
#define SYSCONRCC_XTAL_10MHZ SYSCONRCC_XTAL(0x10)
